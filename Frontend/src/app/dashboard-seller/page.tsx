  ...
  const carouselSlides = [
    {
      ...
      subtitle: "Pantau inventaris, tingkatkan penjualan, dan jadilah agen perubahan untuk lingkungan bersama ribuan penjual lainnya.",
    ...
    },
    {
      ...
      subtitle: "Tampilkan produk daur ulang Anda ke pasar yang peduli lingkungan dan bangun bisnis berkelanjutan yang sukses.",
    ...
    },
    {
      ...
      subtitle: "Hubungkan produk Anda dengan komunitas pembeli yang aktif mencari solusi ramah lingkungan.",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#f1f8e9] via-[#2fa84f]/15 to-[#0a110b] font-sans text-[#1a2e1f] relative overflow-hidden">
      ...
      <main className="flex-grow container max-w-[1600px] mx-auto pt-24 px-6 pb-20 relative z-10 w-full">
        <div className={`w-full h-[240px] md:h-[280px] rounded-[32px] overflow-hidden relative mb-8 shadow-2xl border border-white/10 ${shouldAnimate ? 'animate-scale-in delay-100' : 'opacity-0'}`}>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-4 mb-10 ${shouldAnimate ? 'animate-fade-in-up delay-200' : 'opacity-0'}`}>
        ...
        <div className={`flex flex-col lg:flex-row gap-8 ${shouldAnimate ? 'animate-fade-in delay-200' : 'opacity-0'}`}>
          <aside className="w-full lg:w-[280px] shrink-0">
            <div className={`bg-[#1a1f1b]/80 backdrop-blur-xl rounded-[32px] p-6 border border-white/5 shadow-2xl sticky top-28 ${shouldAnimate ? 'animate-slide-in-left delay-300' : 'opacity-0'}`}>
